...
#
# Generated by Vivado on Sun Aug 15 02:43:52 +0800 2021
...
0#SD 0#SD 0#SD 0#SD 0#SD 0#unassigned#SD 0#UART 1#UART\
1#unassigned#unassigned#Enet 0#Enet 0}\
...
if { [get_property IS_LOCKED [ get_files -norecurse bd_top.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/AX7020_Zynq.gen/sources_1/bd/bd_top/hdl/bd_top_wrapper.v" ]
} else {
